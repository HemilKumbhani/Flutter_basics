...
ActorMoviesModel actorMoviesModelFromJson(String str) => ActorMoviesModel.fromJson(json.decode(str));

String actorMoviesModelToJson(ActorMoviesModel data) => json.encode(data.toJson());
...
class ActorMoviesModel {
  ...
  factory ActorMoviesModel.fromJson(Map<String, dynamic> json) => new ActorMoviesModel(
